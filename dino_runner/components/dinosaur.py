...
from dino_runner.utils.constants import HAMMER_TYPE, JUMPING, RUNNING, DUCKING, JUMPING_SHIELD, RUNNING_SHIELD, DUCKING_SHIELD, SHIELD_TYPE, DEFAULT_TYPE, HAMMER_TYPE, HEART_TYPE, JUMPING_HAMMER, RUNNING_HAMMER, DUCKING_HAMMER
